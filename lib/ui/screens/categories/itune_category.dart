...
class ItuneContainer extends StatefulWidget {
  @override
  _ItuneContainerState createState() => _ItuneContainerState();
}

class _ItuneContainerState extends State<ItuneContainer> {
  ItemModel item;
