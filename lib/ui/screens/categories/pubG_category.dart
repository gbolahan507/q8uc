...
class PubgContainer extends StatefulWidget {
  PubgContainer({this.item});

  final ItemModel item;
  @override
  _PubgContainerState createState() => _PubgContainerState();
}

class _PubgContainerState extends State<PubgContainer> {
    ...
    return StreamBuilder<bool>(
        ...
        builder: (BuildContext context, AsyncSnapshot<bool> snapshot) {
          return BaseView<ItemsViewModel>(
              onModelReady: (ItemsViewModel model) => model.getPubGCategories(),
